...
var HBoxPlugin = /** @class */ (function (_super) {
    tslib_1.__extends(HBoxPlugin, _super);
    function HBoxPlugin() {
                            ...
                            body: [
                                {
                                    ...
                                    body: [
                                        {
                                            children: (react_1.default.createElement(amis_1.Button, { size: "sm", onClick: function () { return _this.insertRowAfter(context.node); } },
                                                react_1.default.createElement(amis_editor_core_7.Icon, { className: "icon", icon: "arrow-to-bottom" }),
                                                react_1.default.createElement("span", null, "\u4E0B\u65B9\u63D2\u5165\u65B0\u884C")))
                                        },
                                        {
                                            children: (react_1.default.createElement(amis_1.Button, { size: "sm", onClick: function () { return _this.insertRowBefore(context.node); } },
                                                react_1.default.createElement(amis_editor_core_7.Icon, { className: "icon", icon: "top-arrow-to-top" }),
                                                react_1.default.createElement("span", null, "\u4E0A\u65B9\u63D2\u5165\u65B0\u884C")))
                                        }
                                    ]
                                },
                                {
                                    ...
                                    pipeOut: function (value, origin) {
                                        if (Array.isArray(origin)) {
                                            if (origin.length > value) {
                                                ...
                                                origin = origin.concat((0, amis_editor_core_6.repeatArray)({
                                                    body: []
                                                }, value - origin.length));
                                            }
                                        }
                                    ...
                                    options: (0, amis_editor_core_6.repeatArray)(null, 12).map(function (_, index) { return ({
                                    ...
                                    body: [
                                        {
                                            ...
                                            body: [
                                                {
                                                    children: (react_1.default.createElement(amis_1.Button, { size: "sm", onClick: function () {
                                                ...
                                                {
                                                    children: (react_1.default.createElement(amis_1.Button, { size: "sm", onClick: function () { return _this.insertColumnBefore(context); } },
                                                        react_1.default.createElement(amis_editor_core_7.Icon, { className: "icon", icon: "left-arrow-to-left" }),
                                                        react_1.default.createElement("span", null, "\u5DE6\u4FA7\u63D2\u5165\u65B0\u5217")))
                                                },
                                                {
                                                    children: (react_1.default.createElement(amis_1.Button, { size: "sm", onClick: function () { return _this.insertColumnAfter(context); } },
                                                        react_1.default.createElement(amis_editor_core_7.Icon, { className: "icon", icon: "arrow-to-right" }),
                                                        react_1.default.createElement("span", null, "\u53F3\u4FA7\u63D2\u5165\u65B0\u5217")))
                                                }
                                            ]
                                        }
                                    ]
        ...
        _this.overrides = {
            renderColumn: function (node, index) {
                ...
                if (info && node.$$id) {
                    ...
                    return (react_1.default.createElement(amis_editor_core_4.VRenderer, { key: node.$$id, type: info.type, plugin: info.plugin, renderer: info.renderer, "$schema": "" // /schemas/GridColumn.json
                        , hostId: info.id, memberIndex: index, name: "\u7B2C".concat(index + 1, "\u5217"), id: node.$$id, draggable: false, schemaPath: "".concat(info.schemaPath, "/hbox/").concat(index), wrapperResolve: plugin.vWrapperResolve, path: "".concat(this.props.$path, "/").concat(index), data: this.props.data, widthMutable: true }, region ? (react_1.default.createElement(amis_editor_core_5.RegionWrapper, { key: region.key, preferTag: region.preferTag, name: region.key, label: region.label, regionConfig: region, placeholder: region.placeholder, editorStore: plugin.manager.store, manager: plugin.manager, children: dom, wrapperResolve: region.wrapperResolve, rendererName: info.renderer.name })) : (dom)));
                }
                return dom;
            }
        };
    ...
    HBoxPlugin.prototype.onWidthChangeStart = function (event) {
        ...
        event.setData({
            onMove: function (e) {
                ...
                columns[index] = tslib_1.__assign(tslib_1.__assign({}, columns[index]), { width: percent });
    ...
    HBoxPlugin.prototype.insertRowAfter = function (node) {
        ...
        var id = node.id;
        store.traceableSetSchema((0, amis_editor_core_6.JSONChangeInArray)(schema, id, function (arr, node, index) {
            arr.splice(index + 1, 0, (0, amis_editor_core_6.JSONPipeIn)({
                type: 'hbox',
                align: node.align,
                valign: node.valign,
    ...
    HBoxPlugin.prototype.insertRowBefore = function (node) {
        ...
        var schema = store.schema;
        store.traceableSetSchema((0, amis_editor_core_6.JSONChangeInArray)(schema, id, function (arr, node, index) {
            arr.splice(index, 0, (0, amis_editor_core_6.JSONPipeIn)({
                type: 'hbox',
                align: node.align,
                valign: node.valign,
                columns: node.columns.map(function (column) { return ({
...
(0, amis_editor_core_1.registerEditorPlugin)(HBoxPlugin);
