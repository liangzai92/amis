...
exports.TableViewPlugin = void 0;
...
var TableViewEditor_1 = require("../component/TableViewEditor");
/**
 * 尚未实现的功能：
...
function getCellRealPosition(table) {
    ...
    try {
        for (var trs_1 = tslib_1.__values(trs), trs_1_1 = trs_1.next(); !trs_1_1.done; trs_1_1 = trs_1.next()) {
            var tr = trs_1_1.value;
            var tds = tr.tds || [];
            var currentCol = 0; // 当前渲染的实际列
            try {
                for (var tds_1 = (e_2 = void 0, tslib_1.__values(tds)), tds_1_1 = tds_1.next(); !tds_1_1.done; tds_1_1 = tds_1.next()) {
...
var TableViewPlugin = /** @class */ (function (_super) {
    tslib_1.__extends(TableViewPlugin, _super);
    function TableViewPlugin() {
        ...
        _this.panelBody = [
            (0, amis_editor_core_3.getSchemaTpl)('tabs', [
                        ...
                        (0, amis_editor_core_3.getSchemaTpl)('collapseGroup', [
                            {
                                ...
                                body: [
                                    ...
                                    (0, amis_editor_core_3.getSchemaTpl)('caption'),
                                    {
                                        label: '标题位置',
                                        name: 'captionSide',
                                    ...
                                    },
                                    {
                                        ...
                                        pipeIn: (0, amis_editor_core_3.defaultValue)('#eceff8')
                                    }
                                ]
                            }
                        ])
                ...
                },
                {
                    title: '外观',
                    className: 'p-none',
                    body: (0, amis_editor_core_3.getSchemaTpl)('collapseGroup', tslib_1.__spreadArray([], tslib_1.__read((0, amis_editor_core_3.getSchemaTpl)('theme:common')), false))
                },
                {
                    title: '状态',
        ...
        _this.overrides = {
            ...
            renderTr: function (tr, rowIndex) {
                ...
                var plugin = info.plugin;
                var id = tr.$$id;
                return (react_1.default.createElement(amis_editor_core_4.VRenderer, { type: info.type, plugin: info.plugin, renderer: info.renderer, key: id, "$schema": "/schemas/TrObject.json", hostId: info.id, memberIndex: rowIndex, name: "".concat("\u884C ".concat(rowIndex + 1)), id: id, draggable: false, wrapperResolve: plugin.fieldWrapperResolve, schemaPath: "".concat(info.schemaPath, "/tr"), path: "".concat(this.props.$path, "/tr/").concat(rowIndex), data: this.props.data, children: dom }));
            }
        };
                ...
                return [
                    (0, amis_editor_core_3.getSchemaTpl)('tabs', [
                        ...
                        },
                        {
                            title: '外观',
                            className: 'p-none',
                            body: (0, amis_editor_core_3.getSchemaTpl)('collapseGroup', (0, amis_editor_core_3.getSchemaTpl)('theme:common'))
                        }
                    ])
                ];
            }
    ...
    TableViewPlugin.prototype.renderRenderer = function (props) {
        ...
        return (react_1.default.createElement(TableViewEditor_1.TableViewEditor, { schema: schema, manager: this.manager },
            react_1.default.createElement(renderer.component, tslib_1.__assign({}, props))));
    };
    // 根据路径判断是选中单元格还是行
    ...
    TableViewPlugin.prototype.insertRow = function (tdId, position) {
        ...
        var td = (0, amis_editor_core_5.JSONGetById)(table, tdId);
        if (!td) {
        ...
        for (var trIndex = 0; trIndex < table.trs.length; trIndex++) {
            try {
                for (var _b = (e_3 = void 0, tslib_1.__values(table.trs[trIndex].tds || [])), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var td_1 = _c.value;
                    var tdRow = td_1.$$row;
    ...
    TableViewPlugin.prototype.insertCol = function (tdId, position) {
        ...
        try {
            for (var _b = tslib_1.__values(table.trs || []), _c = _b.next(); !_c.done; _c = _b.next()) {
                var tr = _c.value;
                var tds = tr.tds || [];
...
(0, amis_editor_core_1.registerEditorPlugin)(TableViewPlugin);
