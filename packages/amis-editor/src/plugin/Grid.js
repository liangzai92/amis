...
var GridPlugin = /** @class */ (function (_super) {
    tslib_1.__extends(GridPlugin, _super);
    function GridPlugin() {
                ...
                return [
                    (0, amis_editor_core_3.getSchemaTpl)('tabs', [
                                                ...
                                                body: [
                                                    host.isSecondFactor
                                                        ...
                                                        : {
                                                            children: (react_1.default.createElement(amis_1.Button, { size: "sm", onClick: function () {
                                                                ...
                                                                react_1.default.createElement(amis_editor_core_6.Icon, { className: "icon", icon: "arrow-to-bottom" }),
                                                    ...
                                                    host.isSecondFactor
                                                        ...
                                                        : {
                                                            children: (react_1.default.createElement(amis_1.Button, { size: "sm", onClick: function () {
                                                                ...
                                                                react_1.default.createElement(amis_editor_core_6.Icon, { className: "icon", icon: "top-arrow-to-top" }),
                                                        ...
                                                        },
                                                    {
                                                        children: (react_1.default.createElement(amis_1.Button, { size: "sm", onClick: function () { return _this.insertColumnBefore(context); } },
                                                            react_1.default.createElement(amis_editor_core_6.Icon, { className: "icon", icon: "left-arrow-to-left" }),
                                                    ...
                                                    },
                                                    {
                                                        children: (react_1.default.createElement(amis_1.Button, { size: "sm", onClick: function () { return _this.insertColumnAfter(context); } },
                                                            react_1.default.createElement(amis_editor_core_6.Icon, { className: "icon", icon: "arrow-to-right" }),
                        ...
                        },
                        {
                            title: '外观',
                            body: [
                                (0, amis_editor_core_3.getSchemaTpl)('collapseGroup', tslib_1.__spreadArray([], tslib_1.__read((0, amis_editor_core_3.getSchemaTpl)('theme:common', { exclude: ['layout'] })), false))
                            ]
                        }
                    ])
                ];
        ...
        _this.overrides = {
            renderColumn: function (node, index, length) {
                ...
                if (info && node.$$id) {
                    ...
                    return (react_1.default.createElement(amis_editor_core_4.VRenderer, { key: "".concat(node.$$id, "-").concat(index), type: info.type, plugin: info.plugin, renderer: info.renderer, "$schema": "/schemas/GridColumn.json", hostId: info.id, memberIndex: index, name: "\u7B2C".concat(index + 1, "\u680F"), id: node.$$id, draggable: false, schemaPath: "".concat(info.schemaPath, "/grid/").concat(index), wrapperResolve: plugin.vWrapperResolve, path: "".concat(this.props.$path, "/").concat(index), data: this.props.data, widthMutable: true }, region ? (react_1.default.createElement(amis_editor_core_5.RegionWrapper, { key: region.key, preferTag: region.preferTag, name: region.key, label: region.label, regionConfig: region, placeholder: region.placeholder, editorStore: plugin.manager.store, manager: plugin.manager, children: dom, wrapperResolve: region.wrapperResolve, rendererName: info.renderer.name })) : (dom)));
                }
                return dom;
            }
        };
                            ...
                            },
                            {
                                ...
                                body: [
                                    (0, amis_editor_core_3.getSchemaTpl)('layout:originPosition', { value: 'left-top' }),
                                    {
                                        ...
                                        pipeOut: function (value, origin) {
                                            if (Array.isArray(origin)) {
                                                if (origin.length > value) {
                                                    ...
                                                    origin = origin.concat((0, amis_editor_core_7.repeatArray)({
                                                        body: []
                                                    }, value - origin.length));
                                                }
                                            }
                                        ...
                                        options: (0, amis_editor_core_7.repeatArray)(null, 12).map(function (_, index) { return ({
    ...
    GridPlugin.prototype.onWidthChangeStart = function (event) {
        ...
        event.setData({
            onMove: function (e) {
                ...
                columns[index] = tslib_1.__assign(tslib_1.__assign({}, columns[index]), { md: md });
    ...
    GridPlugin.prototype.insertRowAfter = function (node) {
        ...
        var id = node.id;
        store.traceableSetSchema((0, amis_editor_core_7.JSONChangeInArray)(schema, id, function (arr, node, index) {
            arr.splice(index + 1, 0, (0, amis_editor_core_7.JSONPipeIn)({
    ...
    GridPlugin.prototype.insertRowBefore = function (node) {
        ...
        var id = node.id;
        store.traceableSetSchema((0, amis_editor_core_7.JSONChangeInArray)(schema, id, function (arr, node, index) {
            arr.splice(index, 0, (0, amis_editor_core_7.JSONPipeIn)({
                type: _this.rendererName || 'grid',
                align: node.align,
                valign: node.valign,
                columns: node.columns.map(function (column) { return ({
...
(0, amis_editor_core_1.registerEditorPlugin)(GridPlugin);
