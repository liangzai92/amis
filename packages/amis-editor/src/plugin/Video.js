...
var VideoPlugin = /** @class */ (function (_super) {
    tslib_1.__extends(VideoPlugin, _super);
    function VideoPlugin() {
        ...
        _this.scaffold = {
            ...
            poster: (0, amis_editor_core_5.mockValue)({ type: 'image' })
        };
    ...
    VideoPlugin.prototype.filterProps = function (props) {
        props.frames = (0, amis_editor_core_4.JSONPipeOut)(props.frames);
        return props;
    };
...
(0, amis_editor_core_1.registerEditorPlugin)(VideoPlugin);
