...
exports.TableViewEditor = void 0;
...
var TableViewEditor = /** @class */ (function (_super) {
    tslib_1.__extends(TableViewEditor, _super);
    function TableViewEditor(props) {
        var _this = _super.call(this, props) || this;
        _this.preventTableClick = false;
        _this.tableViewWrapperRef = react_1.default.createRef();
    ...
    TableViewEditor.prototype.handleCellMouseDown = function (e) {
        ...
        this.selectedCell = (_a = {},
            _a[tdId] = (0, amis_editor_core_1.JSONGetById)(this.props.schema, tdId),
            _a);
    };
    // 用于单元格合并的移动
    TableViewEditor.prototype.handleCellMouseMove = function (e) {
        if (this.isSelectionCell) {
            ...
            if (!(tdId in this.selectedCell)) {
                this.selectedCell[tdId] = (0, amis_editor_core_1.JSONGetById)(this.props.schema, tdId);
    ...
    TableViewEditor.prototype.findFirstAndLastCell = function () {
        ...
        var lastCell = null;
        try {
            for (var tds_1 = tslib_1.__values(tds), tds_1_1 = tds_1.next(); !tds_1_1.done; tds_1_1 = tds_1.next()) {
    ...
    TableViewEditor.prototype.markSelectingCell = function () {
        ...
        try {
            ...
            for (var _d = tslib_1.__values(this.props.schema.trs), _e = _d.next(); !_e.done; _e = _d.next()) {
                var tr = _e.value;
                try {
                    for (var _f = (e_3 = void 0, tslib_1.__values(tr.tds)), _g = _f.next(); !_g.done; _g = _f.next()) {
                        var td = _g.value;
                        var internalTd = td;
    ...
    TableViewEditor.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (!(0, isEqual_1.default)(prevSchema, thisSchema)) {
            this.syncLineState();
        }
    };
    // 水平或垂直线在鼠标按下去时的通用处理
    ...
    TableViewEditor.prototype.handleRowMouseUp = function (e) {
        ...
        if (!value || !rowElement) {
            ...
            store.changeValueById(draggingId, tslib_1.__assign(tslib_1.__assign({}, value), { height: targetHeight }));
            if (ROW_HEIGHT - targetHeight > 20) {
                amis_1.toast.warning('由于内边距限制，太小的高度设置会不生效，可以调小默认内边距');
            }
        }
    };
    // 垂直线的拖拽
    ...
    TableViewEditor.prototype.handleColMouseUp = function (e) {
        ...
        if (!value || !tdElement) {
            ...
            store.changeValueById(draggingId, tslib_1.__assign(tslib_1.__assign({}, value), { width: targetWidth }));
        }
    };
    // 阻止冒泡防止切换到表格选中
    ...
    TableViewEditor.prototype.renderMergeIcon = function () {
        if (this.state.displayMergeCell) {
            return (react_1.default.createElement("div", { className: "ae-TableViewEditor-mergeIcon", onMouseDown: this.handleMergeCell }, "\u5408\u5E76\u5355\u5143\u683C"));
        }
        return null;
    };
    TableViewEditor.prototype.render = function () {
        ...
        var rowLines = this.state.trIds.map(function (id) { return (react_1.default.createElement("div", { className: "ae-TableViewEditor-rowLine", key: "row-".concat(id), "data-id": id, onMouseDown: _this.handleRowMouseDown })); });
        var colLines = this.state.tdIds.map(function (id) { return (react_1.default.createElement("div", { className: "ae-TableViewEditor-colLine", key: "row-".concat(id), "data-id": id, onMouseDown: _this.handleColMouseDown })); });
        return (react_1.default.createElement("div", { className: "ae-TableViewEditor", ref: this.tableViewWrapperRef, style: schema === null || schema === void 0 ? void 0 : schema.style },
            children,
