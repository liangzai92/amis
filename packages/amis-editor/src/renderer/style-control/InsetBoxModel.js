...
function InsetBoxModel(_a) {
    ...
    function handleChange(styleName) {
        return function (e) {
            ...
            if (!inputValue) {
                onChange(tslib_1.__assign(tslib_1.__assign({}, value), (_a = {}, _a[styleName] = '', _a)));
                return;
            }
            // 数字类型或带有合法单位的字符串都支持
...
exports.default = (0, mobx_react_1.observer)(InsetBoxModel);
var BoxModelRenderer = /** @class */ (function (_super) {
    ...
    BoxModelRenderer.prototype.render = function () {
        return react_1.default.createElement(InsetBoxModel, tslib_1.__assign({}, this.props));
    };
    BoxModelRenderer = tslib_1.__decorate([
        (0, amis_1.FormItem)({ type: 'inset-box-model' })
    ], BoxModelRenderer);
