...
exports.OptionControlRenderer = exports.PartsControlRenderer = exports.MarksControl = exports.PartsControl = void 0;
...
var PartsControl = /** @class */ (function (_super) {
    tslib_1.__extends(PartsControl, _super);
    ...
    PartsControl.prototype.renderHeader = function () {
        ...
        return (react_1.default.createElement("div", { className: (0, classnames_1.default)("".concat(classPrefix, "Form-item"), "".concat(classPrefix, "Form-item--horizontal"), "".concat(classPrefix, "Form-item--horizontal-justify")) },
            react_1.default.createElement("label", { className: (0, classnames_1.default)("".concat(classPrefix, "Form-label"), "".concat(classPrefix, "Form-itemColumn--4")) }, "\u5206\u5757"),
            react_1.default.createElement("div", { className: (0, classnames_1.default)("".concat(classPrefix, "Form-value")) }, render('header', {
                type: 'select',
    ...
    PartsControl.prototype.renderContent = function (source) {
        ...
        if (source === PartsSourceEnum.AVERAGE) {
            return (react_1.default.createElement("div", { className: (0, classnames_1.default)('ae-ExtendMore', "".concat(classPrefix, "Form-item"), "".concat(classPrefix, "Form-item--horizontal"), "".concat(classPrefix, "Form-item--horizontal-justify")) },
                react_1.default.createElement("label", { className: (0, classnames_1.default)("".concat(classPrefix, "Form-label"), "".concat(classPrefix, "Form-itemColumn--4")) }, "\u5757\u6570"),
                react_1.default.createElement("div", { className: (0, classnames_1.default)("".concat(classPrefix, "Form-value")) },
                    react_1.default.createElement(amis_1.NumberInput, { value: parts, onChange: this.handlePartsChange }))));
        }
        else if (source === PartsSourceEnum.CUSTOM) {
            return (react_1.default.createElement("div", { className: "ae-OptionControl-wrapper" }, render('content', (0, amis_editor_core_2.getSchemaTpl)('combo-container', {
                type: 'combo',
                label: false,
                name: 'texts',
                items: [
...
var MarksControl = /** @class */ (function (_super) {
    tslib_1.__extends(MarksControl, _super);
    ...
    MarksControl.prototype.renderHeader = function () {
        ...
        var classPrefix = (_a = env === null || env === void 0 ? void 0 : env.theme) === null || _a === void 0 ? void 0 : _a.classPrefix;
        return (react_1.default.createElement("div", { className: (0, classnames_1.default)("".concat(classPrefix, "Form-item"), "".concat(classPrefix, "Form-item--horizontal"), "".concat(classPrefix, "Form-item--horizontal-justify")) },
            react_1.default.createElement("label", { className: (0, classnames_1.default)("".concat(classPrefix, "Form-label"), "".concat(classPrefix, "Form-itemColumn--4")) }, "\u4E0B\u6807"),
            react_1.default.createElement("div", { className: (0, classnames_1.default)("".concat(classPrefix, "Form-value")) }, render('header', {
                type: 'select',
                name: 'optionSourceList',
    ...
    MarksControl.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: (0, classnames_1.default)('ae-OptionControl', className) },
            ...
            source === MarksSourceEnum.CUSTOM &&
                render('inner', (0, amis_editor_core_2.getSchemaTpl)('combo-container', {
                    type: 'combo',
                    label: false,
                    name: 'texts',
                    draggable: false,
...
var PartsControlRenderer = /** @class */ (function (_super) {
    tslib_1.__extends(PartsControlRenderer, _super);
    function PartsControlRenderer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PartsControlRenderer = tslib_1.__decorate([
        (0, amis_1.FormItem)({
...
exports.PartsControlRenderer = PartsControlRenderer;
