...
(0, amis_editor_core_1.setSchemaTpl)('validations', function () {
    var options = [
        // {
        //     label: '必填',
        //     value: 'isRequired'
    ...
    function firstValue(arr, iterator) {
        var theone = (0, find_1.default)(arr, iterator);
    ...
    return {
        ...
        pipeIn: function (value) {
            if (typeof value === 'string' && value) {
                value = (0, amis_1.str2rules)(value);
            }
...
(0, amis_editor_core_1.setSchemaTpl)('validationErrors', function () {
...
(0, amis_editor_core_1.setSchemaTpl)('submitOnChange', {
    type: 'switch',
    label: '修改即提交',
    name: 'submitOnChange',
    mode: 'horizontal',
...
(0, amis_editor_core_1.setSchemaTpl)('validateOnChange', {
    type: 'select',
...
(0, amis_editor_core_1.setSchemaTpl)('validation', function (config) {
    var a = {
        title: '校验',
        body: [
            tslib_1.__assign({ type: 'ae-validationControl', mode: 'normal' }, config
            ...
            (0, amis_editor_core_1.getSchemaTpl)('validateOnChange')
        ]
    };
    return a;
});
(0, amis_editor_core_1.setSchemaTpl)('validationControl', function (value) {
    ...
    return ({
        ...
        pipeIn: function (value, data) {
            return (0, reduce_1.default)(value, function (arr, item) {
                if (typeof item === 'string') {
                    arr.push(item);
                }
                else {
                    var isAdd_1 = false;
                    // 优先判断是否具备可展示条件
                    (0, forEach_1.default)(item === null || item === void 0 ? void 0 : item.isShow, function (val, key) {
                        if (tslib_1.__spreadArray([], tslib_1.__read(val), false).includes(data === null || data === void 0 ? void 0 : data.data[key])) {
                            isAdd_1 = true;
                            return false;
                        }
                        return true;
                    ...
                    !isAdd_1 &&
                        (0, forEach_1.default)(item === null || item === void 0 ? void 0 : item.isHidden, function (val, key) {
                            var hasExist = tslib_1.__spreadArray([], tslib_1.__read(val), false).includes(data === null || data === void 0 ? void 0 : data.data[key]);
